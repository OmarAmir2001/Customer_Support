...
Revision ID: fb42b724b8d9
Revises: 
Create Date: 2026-08-02 21:33:35.847797
...
def upgrade() -> None:
    ...
    op.create_index('ix_asset_typr', 'assets', ['asset_type'], unique=False)
...
def downgrade() -> None:
    ...
    op.drop_index('ix_asset_typr', table_name='assets')
